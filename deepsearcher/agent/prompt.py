...
def get_vector_db_search_prompt(
    ...
    return f"""
I provide you with collection_name(s) and corresponding collection_description(s). Please select **at most 4** collection names that may be related to the question and return a python list of str. If there is no collection related to the question, you can return an empty list.

"QUESTION": {question}
"COLLECTION_INFO": {collection_info}

When you return, you can ONLY return a python list of str, WITHOUT any other additional content. DO NOT REPLY ANYTHING OTHER THAN THE SELECTED LIST!!!!!!!!!!!! 
...
If the original query is to write a report, then you prefer to generate some further queries, instead return an empty list.
    ...
    footer = """Respond exclusively in valid List of str format without any other text. Example for further queries: 
```python
["<your further queries 1>","<your further queries 2>",....]
```
    """
